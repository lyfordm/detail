...
const ServiceTabs = () => {
  ...
  return (
    <div className="grid grid-col-1 md:grid-cols-3 gap-8 sm:mx-2">
      {serviceList.map((service, index) => (
        ...
        >
          ...
          <Link
            ...
            className="flex items-center justify-center md:w-3/5 sm:w-4/5 font-jost bg-darkgrey text-white font-medium rounded-full px-6 py-3 shadow-lg  hover:text-darkgrey hover:bg-white self-center"
          >
